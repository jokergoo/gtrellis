...
Anyway, you can use `grid.layout` to arrange multiple continuous regions on the plot withusing **ggbio** and **Gviz**,
...
whether to add axis ticks on the other side. (You can compare following figure to the above one.)
...
In following example, we additinally add graphics for hypo-DMR as well so that
...
we explictly specify value of `track` argument to 2.
