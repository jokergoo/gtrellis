...
\arguments{
  ...
  \item{category}{subset of categories (e.g. chromosomes). The value can be a vector which contains more than one category.}
  ...
  \item{panel.fun}{self-defined panel function to add graphics in each 'cell'. THe argument \code{gr} in \code{panel.fun}  only contains data for the current category which is a subset of the main \code{gr}.}
...
\code{grid} system also support a large number of coordinate systems by defining proper \code{\link[grid]{unit}} object  which provides high flexibility to place graphics on the plotting regions.  
